...
import com.example.basketball.controller.activities.master_detail.FindPlayers;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        if(userToken!=null) {
            findPlayers = (Button) findViewById(R.id.findPlayers);
            findPlayers.setOnClickListener(new View.OnClickListener() {
                   @Override
                   public void onClick(View v) {
                       Intent i = new Intent(v.getContext(), FindPlayers.class);
                       startActivity(i);
                   }
            });
